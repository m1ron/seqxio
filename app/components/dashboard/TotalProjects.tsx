  ...
  return (
    <>
      <div className='flex lg:flex-row flex-col  justify-between gap-4 md:mb-8 mb-4 gap-3 md:flex-row flex-col'>
        <div>
          <h1 className='font-medium md:text-custom-4xl text-3xl text-black leading-[79%]'>Dashboard</h1>
          <Paragraph className='md:text-xl text-base font-light leading-120 text-light-green mt-2.5 tracking-[-.021em]'>Monitor and manage waste collection operations in real-time.</Paragraph>
        </div>
