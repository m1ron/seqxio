    ...
    return (
        <Modal open={open} onClose={onClose} modalClass="md:max-w-170">
            <div className="flex h-full flex-col bg-white">
                ...
                <div className="flex-1 overflow-y-auto scrollbar-hidden px-4 md:px-6 py-5">
                    {step === 1 ? (
                        <div className="space-y-6">
                            <section className="space-y-1 mb-6.5">
                            ...
                            <section className="flex gap-2 items-center mb-7">
                                <h3 className="text-sm font-semibold text-midnight-blue">
                                    Photo Type*
                                </h3>

                                <Tabs
                                    className="bg-cool-mist p-1 rounded-md gap-0 [&>li>button]:rounded-sm [&>li>button]:px-3 [&>li>button]:py-1.5"
                                    tabs={[
                                        { label: "Before", value: "before" },
                                        { label: "During", value: "during" },
                                        { label: "After", value: "after" },
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <div className="flex min-h-44 flex-col items-center justify-center text-center">
                                    ...
                                    <span className="mt-3 py-1.75 px-4 text-sm leading-6 font-medium rounded-[15px] border border-dark-green text-dark-green bg-white">
                                        Browse files
                                    </span>
