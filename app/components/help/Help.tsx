...
export default function Help({ heading, subheading }: HelpProps) {
    return (
                        ...
                        <QuickHelp items={[
                            {
                                ...
                                icon: "/assets/images/help/quick/dashboard.svg",
                            },
                            {
                                ...
                                icon: "/assets/images/help/quick/projects.svg",
                            },
                            {
                                ...
                                icon: "/assets/images/help/quick/calendar.svg",
                            },
                        ]} />
                    </div>
                </section>
