...
const Icons: React.FC<LoginCardProps> = ({ icon, className, pathClassName }) => {
    const iconList = {
        ...
        calendar: (<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 25 25"><rect width="21.177" height="18.823" x="2" y="3.176" stroke="#7b9182" strokeWidth="2" rx="4"/><path stroke="#7b9182" strokeWidth="2" d="M2 9.059h21.177"/><path stroke="#7b9182" strokeLinecap="round" strokeWidth="2" d="M7.882 2v2.353M17.294 2v2.353"/><circle cx="17.882" cy="14.353" r="1.765" fill="#7b9182"/></svg>),
        ...
        arrowRight: (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.333"><path d="M3.334 8h9.333M8 3.333 12.667 8 8 12.667"/></g></svg>),

        quickHelpDashboard: (<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none"><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.667" d="M12 4H5.333C4.597 4 4 4.597 4 5.333v9.334C4 15.403 4.597 16 5.333 16H12c.736 0 1.333-.597 1.333-1.333V5.333C13.333 4.597 12.736 4 12 4M26.666 4h-6.667c-.736 0-1.333.597-1.333 1.333v4c0 .737.597 1.334 1.333 1.334h6.667c.736 0 1.333-.597 1.333-1.334v-4C28 4.597 27.402 4 26.666 4M26.666 16h-6.667c-.736 0-1.333.597-1.333 1.333v9.334c0 .736.597 1.333 1.333 1.333h6.667c.736 0 1.333-.597 1.333-1.333v-9.334c0-.736-.597-1.333-1.333-1.333M12 21.333H5.333c-.736 0-1.333.597-1.333 1.334v4C4 27.403 4.597 28 5.333 28H12c.736 0 1.333-.597 1.333-1.333v-4c0-.737-.597-1.334-1.333-1.334"/></svg>),
        quickHelpProjects: (<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none"><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.667" d="M20 2.667h-8c-.737 0-1.334.597-1.334 1.333v2.667c0 .736.597 1.333 1.333 1.333h8c.737 0 1.334-.597 1.334-1.333V4c0-.736-.597-1.333-1.334-1.333"/><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.667" d="M21.334 5.333h2.667A2.667 2.667 0 0 1 26.667 8v18.667a2.667 2.667 0 0 1-2.666 2.666H8a2.667 2.667 0 0 1-2.667-2.666V8a2.667 2.667 0 0 1 2.667-2.667h2.666M16 14.667h5.333M16 21.333h5.333M10.666 14.667h.013M10.666 21.333h.013"/></svg>),
        quickHelpCalendar: (<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none"><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.667" d="M10.666 2.667V8M21.334 2.667V8M25.333 5.333H6.667A2.667 2.667 0 0 0 4 8v18.667a2.667 2.667 0 0 0 2.667 2.666h18.666A2.667 2.667 0 0 0 28 26.667V8a2.667 2.667 0 0 0-2.667-2.667M4 13.333h24"/></svg>),

        troubleshootingUpdating: (<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.667" d="M2.5 10A7.5 7.5 0 0 1 10 2.5a8.13 8.13 0 0 1 5.617 2.283L17.5 6.667"/><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.667" d="M17.5 2.5v4.167h-4.166M17.5 10a7.5 7.5 0 0 1-7.5 7.5 8.13 8.13 0 0 1-5.617-2.283L2.5 13.333"/><path stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.667" d="M6.667 13.333H2.5V17.5"/></svg>),
        troubleshootingNotLoading: (<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.667" clipPath="url(#a)"><path d="M10 16.667h.008M7.084 13.69a4.167 4.167 0 0 1 5.833 0M4.166 10.716a8.33 8.33 0 0 1 4.308-2.242M15.833 10.716a8.3 8.3 0 0 0-1.673-1.27M1.666 7.35a12.5 12.5 0 0 1 3.48-2.203M18.332 7.35a12.5 12.5 0 0 0-9.406-3.137M1.666 1.667l16.667 16.666"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>),
        troubleshootingNotPerform: (<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.667" clipPath="url(#a)"><path d="m1.666 1.667 16.667 16.666M4.167 4.167A.833.833 0 0 0 3.334 5v5.833c0 4.167 2.917 6.25 6.392 7.45.18.067.376.07.558.009 1.958-.684 3.733-1.642 4.917-3.092M7.758 3.043A10.2 10.2 0 0 0 9.367 1.9a.975.975 0 0 1 1.267 0c1.458 1.275 3.533 2.267 5.2 2.267a.833.833 0 0 1 .833.833v5.833q0 .528-.067 1.054"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>),
        troubleshootingTime: (<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><g stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.667" clipPath="url(#a)"><path d="M10 5v5l3.333 1.667"/><path d="M10 18.333a8.333 8.333 0 1 0 0-16.666 8.333 8.333 0 0 0 0 16.666"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>),
