...
const Icons: React.FC<LoginCardProps> = ({ icon, className, pathClassName }) => {
    const iconList = {
        ...
        close: (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 6 6 18M6 6l12 12"/></svg>),
